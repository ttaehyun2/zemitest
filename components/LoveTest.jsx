    ...
    <div className="lu-root">
      ...
      {screen === "result" && result && (
        <div className="lu-result-wrap">
          ...
          <CommentJump pageId="test-love" count={cmtCount} />

          <div className="lu-actions">
            <ShareButtons
              text={`나의 연애 세계관은 「${result.top.emoji} ${result.top.name}」 ${result.top.pct}%\n"${result.top.tagline}"\n\n너의 연애 세계관도 알아봐 👀`}
          ...
          <Comments pageId="test-love" title="다들 뭐 나왔어요?" onCount={setCmtCount} />
        </div>
      )}
    </div>
  );
