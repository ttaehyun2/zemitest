...
def make(filename, eyebrow, title, sub, emoji, accent, bg=("#5f4a9c", "#7458bd", "#7f62c8")):
...
ITEMS = [
    ...
    ("lifesim.png", "LIFE SIMULATION", "당신의 인생은 어떻게 끝날까?",
     "3,700가지 경로 · 엔딩 28종 · 예고 없는 죽음", "🎲", "#ffd6a5"),
    ...
    ("karma.png", "FINAL JUDGMENT", "천국에 갈까 지옥에 갈까?",
     "24문항 · 천국 9층 · 연옥 · 지옥 9층", "⚖️", "#ffd6a5"),

    ("stock.png", "STOCK SURVIVAL", "주식 시작하면 얼마나 버틸까?",
     "22문항 · 계좌 생존 기간 · 생존 확률", "📈", "#84fab0"),

    ("princess.png", "PRINCESS TEST", "나는 공주병일까 자존감이 낮은 걸까?",
     "20문항 · 7단계 스펙트럼", "👑", "#ffd6a5"),

    ("youtube.png", "YOUTUBER TEST", "당신이 유튜버라면 구독자 몇 명?",
     "실버 10만 · 골드 100만 · 다이아 1000만", "📺", "#ff8a8a"),
    ...
    ("pastlife.png", "PAST LIFE TEST", "전생에 나는 무엇이었을까?",
     "20문항 · 결과 12종 · 전생의 인연까지", "🔮", "#c9a5ff"),

    ("animal.png", "ANIMAL TEST", "나와 닮은 동물은 무엇일까?",
     "22문항 · 결과 16종 · 강아지부터 독수리까지", "🐾", "#ffd6a5"),
